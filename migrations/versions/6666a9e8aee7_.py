...
Revision ID: 6666a9e8aee7
Revises: 
Create Date: 2017-12-01 22:04:03.641608
...
def upgrade_gis_rhone_alpes():
    # ### commands auto generated by Alembic - please adjust! ###
    op.create_table('rhone_alpes_line',
    ...
    sa.Column('harbor', sa.Text(), nullable=True),
    ...
    op.create_table('rhone_alpes_nodes',
    sa.Column('id', sa.BigInteger(), nullable=False),
    ...
    op.create_table('rhone_alpes_point',
    sa.Column('id', sa.BigInteger(), nullable=False),
    sa.Column('osm_id', sa.BigInteger(), nullable=True),
    sa.Column('access', sa.Text(), nullable=True),
    sa.Column('addr:housename', sa.Text(), nullable=True),
    ...
    sa.Column('poi', sa.Text(), nullable=True),
    sa.Column('way', Geometry(geometry_type='POINT'), nullable=True),
    sa.PrimaryKeyConstraint('id')
    )
    op.create_table('rhone_alpes_polygon',
    sa.Column('id', sa.BigInteger(), nullable=False),
    sa.Column('osm_id', sa.BigInteger(), nullable=True),
    sa.Column('access', sa.Text(), nullable=True),
    sa.Column('addr:housename', sa.Text(), nullable=True),
    ...
    op.create_table('rhone_alpes_rels',
    sa.Column('id', sa.BigInteger(), nullable=False),
    ...
    op.create_table('rhone_alpes_roads',
    sa.Column('id', sa.BigInteger(), nullable=False),
    sa.Column('osm_id', sa.BigInteger(), nullable=True),
    sa.Column('access', sa.Text(), nullable=True),
    sa.Column('addr:housename', sa.Text(), nullable=True),
    ...
    op.create_table('rhone_alpes_ways',
    sa.Column('id', sa.BigInteger(), nullable=False),
...
def downgrade_gis_rhone_alpes():
    ...
    op.drop_table('rhone_alpes_ways')
    op.drop_table('rhone_alpes_roads')
    op.drop_table('rhone_alpes_rels')
    op.drop_table('rhone_alpes_polygon')
    op.drop_table('rhone_alpes_point')
    op.drop_table('rhone_alpes_nodes')
    op.drop_table('rhone_alpes_line')
    # ### end Alembic commands ###
