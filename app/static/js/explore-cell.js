...
$(document).ready(function () {
    ...
    var searchSingleOption_source = document.getElementById("search-single-option-template").innerHTML;
    var searchSingleOptionTemplate = Handlebars.compile(searchSingleOption_source);

    var poiSingleOptions_source = document.getElementById("poi-single-option-template").innerHTML;
    var poiSingleOptionsTemplate = Handlebars.compile(poiSingleOptions_source);
