...
class rhones_alpes_line(db.Model):
...
class rhones_alpes_nodes(db.Model):
    __bind_key__ = 'gis_rhone_alpes'
...
class rhones_alpes_point(db.Model):
    __bind_key__ = 'gis_rhone_alpes'
...
class rhones_alpes_polygon(db.Model):
    __bind_key__ = 'gis_rhone_alpes'
...
class rhones_alpes_rels(db.Model):
    __bind_key__ = 'gis_rhone_alpes'

    id = db.Column(db.BigInteger, primary_key=True,nullable=False)
    way_off = db.Column(db.SmallInteger)
    rel_off = db.Column(db.SmallInteger)
    parts = db.Column(db.BigInteger)
    members = db.Column(db.Text)
    tags = db.Column(db.Text)

class rhones_alpes_roads(db.Model):
    __bind_key__ = 'gis_rhone_alpes'
...
class rhones_alpes_ways(db.Model):
    __bind_key__ = 'gis_rhone_alpes'

    id = db.Column(db.BigInteger, primary_key=True, nullable=False)
    nodes = db.Column(db.BigInteger, nullable=False)
    tags = db.Column(db.Text)